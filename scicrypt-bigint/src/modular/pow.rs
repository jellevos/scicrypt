...
mod tests {
    ...
    fn test_powmod_small_base() {
        ...
        let expected = UnsignedInteger::from_string("".to_string(), 10, 1024);
        assert_eq!(res, expected);
    }

    #[test]
    fn test_powmod_small_base_oversized() {
        let b = UnsignedInteger::from_string("105".to_string(), 10, 1024);
        let e = UnsignedInteger::from_string("".to_string(), 10, 1024);
        let m = UnsignedInteger::from_string("".to_string(), 10, 1024);
    ...
    fn test_powmod_small_exponent() {
        let b = UnsignedInteger::from_string("".to_string(), 10, 1024);
        let e = UnsignedInteger::from_string("105".to_string(), 10, 7);
        let m = UnsignedInteger::from_string("".to_string(), 10, 1024);
